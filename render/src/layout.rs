...
fn apply_calc_single_page_axis_fit<I: Copy>(
    slots: &mut [MeasuredAxisSlot<I>],
    source_twips: &[i128],
    page_extent: Fixed,
    options: &RenderOptions,
...
fn calc_draw_strings_visible_width(
    clip_width: Fixed,
    base_margin: Fixed,
...
fn calc_draw_strings_short_utf16_len(
    visible_width: Fixed,
    text_width: Fixed,
    utf16_len: usize,
...
fn expand_draw_strings_cutoff_to_cluster_boundary(
...
fn utf16_prefix_byte_len(text: &str, units: usize) -> usize {
...
fn utf16_suffix_byte_len(text: &str, units: usize) -> usize {
    let mut consumed = 0_usize;
...
fn text_style(region: &Region, options: &RenderOptions) -> TextStyle {
...
mod tests {
    ...
    fn auxiliary_text_does_not_use_worksheet_draw_strings_shortening() {
        ...
        let node = build_auxiliary_text_node_with_clip_and_kerning(
            ...
            Fixed::from_pixels(2),
            ChartTextRole::AxisLabel.style(
                options.default_font_family.as_str(),
                TextAnchor::Start,
                0,
            ),
            true,
