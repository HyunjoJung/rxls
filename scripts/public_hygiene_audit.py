...
SECRET_PATTERNS = (
    ...
    ("crates_io_token", re.compile(r"\bcio[A-Za-z0-9_-]{20,}\b")),
...
INTERNAL_TRACE_PATTERNS = (
    ...
    (
        ...
        re.compile(r"\b(?:" + "T" + "RD|" + "P" + r"RD)\b", re.IGNORECASE),
    ),
    (
...
INTERNAL_PLANNING_BASENAMES = {"T" + "RD.MD", "P" + "RD.MD"}
...
def scan_internal_planning_name(path: str, display_path: str | None = None) -> list[Finding]:
    ...
    if basename.startswith(INTERNAL_PLANNING_PREFIXES) or basename in INTERNAL_PLANNING_BASENAMES:
        return [
            Finding(
