...
fn corpus_failure_kind(err: &Error) -> &'static str {
    match err {
        ...
        Error::Zip("invalid office-document relationship") => "invalid_ooxml_relationships",
...
fn corpus_failure_decision(kind: &str) -> &'static str {
    match kind {
        ...
        "invalid_ooxml_relationships" | "malformed_biff" | "malformed_xml" => {
...
fn corpus_failure_evidence(kind: &str, container: &str, extension_mismatch: bool) -> &'static str {
    match (kind, container, extension_mismatch) {
        ...
        ("invalid_ooxml_relationships", "zip", _) => "ooxml_package_relationships_invalid",
